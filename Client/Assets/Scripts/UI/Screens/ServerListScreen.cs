...
public partial class ServerListScreen : mScreen, IActionListener
{
    ...
    public static string linkDefault = "Omni Dragon:127.0.0.1:14445:0,0,0";
   //public static string linkDefault = Decrypt("勶勹動勹勷勸匓匜勲勧勘匝勱匎勹匙勱匎勥匝勰匎勩勗勱勸匓匞勳勨勽匛勳匎勥北勱勧匛匛", 545444);
    ...
    public override void switchToMe()
    {
        ...
        {
            num = 1;
            Rms.saveRMSString("ResVersion", "1");
        }
        loadScreen = true;
    ...
    public void switchToMe2()
    {
        ...
        int num2 = (text2 == null || !(text2 != string.Empty)) ? (-1) : int.Parse(text2);
        if (num2 <= 0)
        {
            num2 = 1;
            Rms.saveRMSString("ResVersion", "1");
