...
public class Panel : IActionListener, IChatable
{
    ...
    private void paintInventory(mGraphics g)
    {
        ...
        if (hasSubTabs)
        {
            ...
            // Tab 0: Túi đồ
            g.setColor((subTabInventory == 0) ? 16773296 : 14935011);
            ...
            // Tab 1: Trang bị
            g.setColor((subTabInventory == 1) ? 16773296 : 14935011);
    ...
    private void paintTab(mGraphics g)
    {
        ...
        // Draw inactive tabs first (narrower for gap)
        for (int i = 0; i < currentTabName.Length; i++)
        {
            ...
            int tabW = TAB_W - 2;
            g.setColor(16773296);
            PopUp.paintPopUp(g, tabX, 52, tabW, 25, 0, isButton: true);
            if (i == keyTouchTab)
            {
        ...
        // Draw active tab last (on top, also narrower)
        {
            int tabX = startTabPos + currentTabIndex * TAB_W + 1;
            int tabW = TAB_W - 2;
            g.setColor(6805896);
            PopUp.paintPopUp(g, tabX, 52, tabW, 25, 1, isButton: true);
