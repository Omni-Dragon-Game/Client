...
public class mFont
{
	...
	public mFont(sbyte id)
	{
		...
		try
		{
			if (myFont != null && myFont.material != null && myFont.material.mainTexture != null)
			{
	...
	private static GUIStyle sharedStyle;

	private static GUIStyle getSharedStyle()
	{
		if (sharedStyle == null)
		{
			sharedStyle = new GUIStyle(GUI.skin.label);
			sharedStyle.normal.background = null;
			sharedStyle.hover.background = null;
			sharedStyle.active.background = null;
			sharedStyle.focused.background = null;
			sharedStyle.onNormal.background = null;
			sharedStyle.onHover.background = null;
			sharedStyle.onActive.background = null;
			sharedStyle.onFocused.background = null;
		}
		return sharedStyle;
	}
	...
	public int getWidthExactOf(string s)
	{
		try
		{
			GUIStyle gUIStyle = getSharedStyle();
