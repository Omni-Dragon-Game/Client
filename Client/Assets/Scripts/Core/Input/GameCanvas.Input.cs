...
public partial class GameCanvas
{
    ...
    public static bool isTyping()
    {
        return (ChatTextField.gI() != null && ChatTextField.gI().isShow) ||
               (panel != null && panel.chatTField != null && panel.chatTField.isShow) ||
               (panel2 != null && panel2.chatTField != null && panel2.chatTField.isShow);
    }
    ...
    public void mapKeyPress(int keyCode)
    {
        ...
        switch (keyCode)
        {
            ...
            case 119:
            case 87:
                if (isTyping() && (keyCode == 119 || keyCode == 87))
                {
                    break;
                }
            ...
            case 115:
            case 83:
                if (isTyping() && (keyCode == 115 || keyCode == 83))
                {
                    break;
                }
                if ((currentScreen is GameScr || currentScreen is CrackBallScr) && Char.myCharz().isAttack)
            ...
            case 97:
            case 65:
                if (isTyping() && (keyCode == 97 || keyCode == 65))
                {
                    break;
                }
                if ((currentScreen is GameScr || currentScreen is CrackBallScr) && Char.myCharz().isAttack)
            ...
            case 100:
            case 68:
                if (isTyping() && (keyCode == 100 || keyCode == 68))
                {
                    break;
                }
                if ((currentScreen is GameScr || currentScreen is CrackBallScr) && Char.myCharz().isAttack)
